...
M.setup = function()
	...
	hl("@markup.strong", { fg = palette.hex10, bold = true })
	hl("@markup.italic", { fg = palette.hex10, italic = true })
	hl("@markup.strikethrough", { fg = palette.hex10, strikethrough = true })
	hl("@markup.underline", { fg = palette.hex10, underline = true })
